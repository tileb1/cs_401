...
from .loss import ClipLoss, DistillClipLoss, CoCaLoss, SigLipLoss, MultiCLSLoss, ZSLoss
    ...
    **model_kwargs,
    ...
    if pretrained and pretrained.lower() == "openai":
        ...
        if model_name.startswith("ours"):
            ...
            model = OursCLIP(args, **model_cfg, **model_kwargs, cast_dtype=cast_dtype)
        elif custom_text:
            if is_hf_model:
            ...
            if "coca" in model_name:
                ...
                model = CustomTextCLIP(
                    **model_cfg, **model_kwargs, cast_dtype=cast_dtype
                )
        else:
...
def create_loss(args):
    if args.distill:
        ...
        return ZSLoss(
            ...
            world_size=args.world_size,
            use_horovod=args.horovod,
            use_dense_loss=args.loss_type == "cls" and args.n_dense_cls,
            args=args,
        )
    return ClipLoss(
        local_loss=args.local_loss,
