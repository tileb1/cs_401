...
def main(args):
    if isinstance(args, list):
        args = parse_args(args).parse_args(
            args
        )  # weird interface to stay more compatible with open-clip
    print(args)
    ...
    if args.world_size > 1:
        ...
        args.patch_size = (
            14  # model.model.visual.patch_size[0] TODO: fix this!!!!!!!!!!!!!!!!!!!!
        )
    data = get_data(
        args,
    ...
    if args.mode == "train":
        ...
        for epoch in range(start_epoch, args.epochs):
            ...
            if any(
                v in data for v in ("val", "imagenet-val", "imagenet-v2", "coco_val")
            ):
