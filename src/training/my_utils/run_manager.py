...
def get_parser(add_mmseg_args=False, add_mmdet_args=False):
    parser = argparse.ArgumentParser(
        "Submitit for SamNo", parents=[get_args_parser(None)]
    )
    parser.add_argument(
    ...
    parser.add_argument(
        "--cpu_per_task", default=12, type=int, help="Number of CPUs per GPU."
    )
    parser.add_argument(
        "--comment",
        default="",
    ...
    parser.add_argument(
        "--repos_path",
        type=str,
        default="/home/stegmuel/projects/",
    ...
    parser.add_argument(
        ...
        default="",
        type=str,
        help="Dataset path for the OD datasets.",
    )
    parser.add_argument(
        "--slurm_partition", default="", type=str, help="Slurm partition."
    )
    parser.add_argument("--slurm_account", default="", type=str, help="Slurm account.")
    parser.add_argument(
        "--slurm_qos", default=None, type=str, help="QOS for slurm job."
    )
    parser.add_argument(
        "--gb_ram_per_gpu",
        default=62,
        type=int,
        help="Amount of main memory per GPU in GB",
    )
    ...
    parser.add_argument(
        "--slurm_reservation", default=None, type=str, help="Reservation for slurm job."
    )
    parser.add_argument(
        "--slurm_hint",
        default=None,
    ...
    parser.add_argument(
        "--output_dir", default="", type=str, help="Make code backwards compatible."
    )
